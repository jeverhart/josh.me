	    	...
	    	function rotate(elem){
				setTimeout(function(){
					elem.textContent = 'brand';
					setTimeout(function(){
						elem.textContent = 'clients';
						setTimeout(function(){
							elem.textContent = 'code';
							setTimeout(function(){
								elem.textContent = 'design';
								setTimeout(function(){
									elem.textContent = 'deadlines';
								}, 1000);
							}, 1000);
						}, 1000);
					}, 1000);
    		...
    		function load(){	    		
				var elem = document.querySelector('#trust-text');
	    	...
	    	Portfolio = {
	    		...
	    		init: function(){
	    			...
	    			Portfolio.homeBodyContent = document.getElementById("home-body-content");
	    		...
	    		animateHeader: function() {
	    			...
	    			//Portfolio.experience.classList.add("animate");
	    		...
	    		animateSplitText: function(element, splitText, yDelta, baseDelay, initialLoad){
	    			if (initialLoad){
	    				var initialDelay = Portfolio.initialDelay(element, 0.56 / 1000, 0);
	    			}
	    			else {
	    				var initialDelay = 0;
	    			}
